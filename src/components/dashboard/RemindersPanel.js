...
export default function RemindersPanel({ lowStockItems = [] }) {
  ...
  return (
    <div className="glass-card p-8 flex flex-col h-full bg-slate-50/30 border-dashed border-emerald-100/50">
      ...
      <button className="mt-8 bg-emerald-800 hover:bg-emerald-900 text-white rounded-2xl py-4 px-6 flex items-center justify-center gap-3 transition-all active:scale-95 shadow-lg shadow-emerald-200 group">
